...
To build the final jar and optimize the H24Gatway application for production, run:
...
Then navigate to [http://localhost:21001](http://localhost:21001) in your browser.
